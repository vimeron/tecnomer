            ...
            out.println("<div id='content'>");
                ...
                out.println("<tr>"
                        ...
                        + "<td><a href='catalog/updateProduct.jsp?"
                            + "id=" + dato.getIdproducto() + "&"
                            + "prod=" + dato.getNombreproducto()+ "&"
                            + "val=" + dato.getValor()+ "&"
                            + "cat=" + dato.getIdCatalogo()+ "&"
                            + "img=" + dato.getImagen()+ "'>" + dato.getNombreproducto()+ "</a></td>"
                ...
                out.println ("Nota: Para actualizar un producto de clic sobre el nombre correspondiente.");
