    ...
    <table width="200" align="center">
      ...
      <tr>
        <td align="center"><label>
          <input name="imagen" type="radio" id="imagen_2" value="Camera.png" checked="CHECKED">
          Ninguna<img src="../images/ImagenNoDisponible.png" width="100" height="100"></label></td>
...
Computador<img src="../images/Computer.png" width="100" height="100" alt=""></td>
        <td align="center"><input type="radio" name="imagen" value="Gaming-Pad.png" id="imagen_"> 
          Game Pad
<img src="../images/Gaming-Pad.png" width="100" height="100" alt=""></td>
...
Headphones<img src="../images/Headphones.png" width="100" height="100" alt=""></td>
      ...
      <tr>
        ...
        iPod
        <img src="../images/iPod.png" width="100" height="100" alt=""></td>
